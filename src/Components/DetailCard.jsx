            ...
            <div className="w-full h-[33%] p-[20px] flex flex-col justify-between">
                <div className="flex justify-between">
                    <div className="flex items-center">
                        ...
                        <p className="font-semibold text-[25px] text-white capitalize">{selectedPokemon.name}</p>
                    </div>
    
                    <div className="flex items-center">
                        <p className="text-[25px] font-semibold text-white">#{selectedPokemon.id}</p>
                    </div>
                </div>
                ...
                <div className="w-full h-full flex flex-col rounded-[10px] ">
                    ...
                    <div>
                        <div className="flex justify-center mt-[20px] ">
                            <h3 className={`font-bold text-[20px] id${pokemonType} text-2xl`}>About</h3>
                        </div>
                        ...
                        <div className={`flex flex-col mt-[20px] id${pokemonType}`}>
                            <p className="text-center font-bold text-2xl">Base Stats</p>
